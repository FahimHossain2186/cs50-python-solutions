...
[![Course](https://img.shields.io/badge/Course-CS50P-blue.svg)](https://cs50.harvard.edu/python/2022/)
...
```text
cs50-python-solutions/
├── setup.py             # Configures the repo as a local Python package
├── pset0/               # Functions, Variables
├── pset1/               # Conditionals
├── pset2/               # Loops (e.g., twttr, camelCase)
├── pset3/               # Exceptions
├── pset4/               # Libraries
├── pset5/               # Unit Tests (e.g., test_twttr, test_bank)
└── ...
